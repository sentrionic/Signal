...
export class AppService implements OnModuleInit {
  ...
  async seedDatabase(): Promise<void> {
    ...
    user1.id = '1ad7a449-abdf-48e9-8262-e6071fca9540';
    const user2 = new User('felsa@example.com', 'Felsa', 'password');
    user2.id = '4e18d808-1a8e-46b9-a2d3-6d752e5396db';
    const user3 = new User('bel@example.com', 'Bel', 'password');
    user3.id = 'bc901c34-5ba7-4477-bc2d-a93b80ce5f34';
